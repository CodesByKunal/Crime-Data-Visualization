...
loginRouter.get('/', async (req, res) => {
    try {
        ...
        if (passwordMatch) {
            ...
            let access_token = jwt.sign({ username: userMatch.username, _id: userMatch._id }, 'shhhhh');
            res.cookie('access_token', access_token, { signed: true, secure: true, httpOnly: true, domain: 'localhost' });
