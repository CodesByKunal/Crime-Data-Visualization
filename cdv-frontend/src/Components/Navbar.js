...
export default function Navbar() {
  ...
  return (
    <>
      {/* Navbar Parent Box */}
      <div
        className={`h-dvh sm:h-screen sm:w-20 w-16 om sticky top-0 left-0 bg-yt ${
          open ? "sm:w-52 w-48" : ""
        } transform duration-100 flex flex-col justify-center items-center gap-1 overflow-hidden`}
        onClick={() => {
          setOpen(true);
        }}
      >
        ...
        <div className="h-40  w-full flex justify-center items-start p-2">
          {/* App Name */}
          <div className="p-2 bg-violet-800 rounded-md w-full flex flex-row justify-center items-center">
            <div>
              <svg
        ...
        <div className="h-full border-b border-gray-700 w-full p-2 space-y-5 flex justify-center flex-col">
          {/* Profile */}
          <div className="p-2  hover:bg-yt-h rounded-md w-full flex flex-row justify-center items-center">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
        ...
        <div className="h-full  w-full flex justify-end items-end p-2 flex-col gap-3">
          {/* Close Button */}
          <div
            className={`p-2  text-red-600 hover:bg-red-900 hover:text-white rounded-md w-full flex flex-row justify-center items-center ${
              open ? "block" : "hidden"
            }`}
            onClick={(event) => {
              setOpen(false);
          ...
          >
            ...
            <div className={`w-full text-l ml-6  ${open ? "block" : "hidden"}`}>
              Close
            </div>
          </div>
          {/* Logout */}
          <div className="p-2 bg-red-700 hover:bg-red-900 rounded-md w-full flex flex-row justify-center items-center">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
